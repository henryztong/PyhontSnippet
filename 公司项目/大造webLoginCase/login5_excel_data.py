...
def login_test(dict,user):
	...
	# log = Loginfo() # 创建一个log实例对象,写入txt文本
	log = XLLoginfo()
...
if __name__ == '__main__':
	...
	# '''
	# company_userinfo = 'G:\case\userinfo.txt'
	# home_userinfo = 'D:\Learn\case\userinfo.txt'
	# Mac_userinfo = '/Volumes/A/case/logincase/userinfo.txt'
	# company_webinfo = 'G:\case\webinfo.txt'
	# home_webinfo = 'D:\Learn\case\webinfo.txt'
	# Mac_webinfo = '/Volumes/A/case/logincase/webinfo.txt'

	# 将数据存放在txt文件中，从txt文件获取数据
	# user_list = get_userinfo(r'G:\case\userinfo.txt') 
	# ele_dict = get_webinfo(r'G:\case\webinfo.txt')
	ele_dict = get_webinfo(r'/Volumes/A/case/logincase/webinfo.txt')
	
	# user_list = get_userinfo(r'D:\Learn\case\userinfo.txt') 
	# ele_dict = get_webinfo(r'D:\Learn\case\webinfo.txt')

	# 从excel中获取数据
	# xinfo = XLUserinfo(r'G:\case\userinfo.xls') # 家中pc
	# user_list = xinfo.get_sheetinfo_by_index(0)

	xinfo = XLUserinfo(r'/Volumes/A/case/logincase/userinfo.xls')
	user_list = xinfo.get_sheetinfo_by_index(0)
