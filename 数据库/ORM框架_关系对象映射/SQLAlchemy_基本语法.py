...
# 左连接查询
b = session.query(UserContact.contact_name,UserContact.contact_mobile,UserContact.relation_ship).join(Credit,Credit.id == UserContact.credit_id).filter(Credit.apply_no=='tt20190717181650').all()
print(res)
print(res1)
print(res2)
